...
public class Swordsman extends AttackUnit implements MilitaryUnit, Variables {
	...
	public Swordsman(int armor, int baseDamage) {
	    ...
	    int techLevel = PLUS_ARMOR_SWORDSMAN_BY_TECHNOLOGY; // Obtener nivel de tecnología de defensa
	    int armorWithTech = armor + (armor * techLevel / 100);
	    ...
	    int damageWithTech = baseDamage + (baseDamage * PLUS_ATTACK_SWORDSMAN_BY_TECHNOLOGY * techLevel / 100);
    ...
    public void getExperience() {
        return this.getExperience(); // Obtener la experiencia
    }
}
