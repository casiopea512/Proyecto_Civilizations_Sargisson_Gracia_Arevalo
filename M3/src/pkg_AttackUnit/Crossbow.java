...
public class Crossbow extends AttackUnit implements MilitaryUnit, Variables {
	  ...
	  // Constructor1
		...
		public Crossbow() {
			super();
			 this.setArmor(ARMOR_CROSSBOW); // Establecer la armadura de clase
			    this.setInitialArmor(ARMOR_CROSSBOW); // Establecer la armadura inicial
			    this.setBaseDamage(BASE_DAMAGE_CROSSBOW); // Establecer el daño base
			    this.setExperience(0); // Establecer la experiencia inicial
			    this.setSanctified(false); // Establecer si está santificado o no
